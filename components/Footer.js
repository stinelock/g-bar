...
export default function Footer() {
  return (
    <footer className="grid sm:grid-rows-2 gap-5 fixed bottom-0 bg-dark-grey w-full h-80 py-8 px-20 md:grid md:grid-cols-2 md:grid-rows-none md:h-55 md:px-40">
